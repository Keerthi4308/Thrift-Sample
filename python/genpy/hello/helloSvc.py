...
class Client(Iface):
    ...
    def getMessage(self, name):
        ...
        """
        self.send_getMessage(name)
        return self.recv_getMessage()

    def send_getMessage(self, name):
...
class Processor(Iface, TProcessor):
    ...
    def process_getMessage(self, seqid, iprot, oprot):
        ...
        result = getMessage_result()
        try:
            result.success = self._handler.getMessage(args.name)
...
all_structs.append(getMessage_args)
getMessage_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'name', 'UTF8', None, ),  # 1
)


class getMessage_result(object):
    """
    Attributes:
     - success
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getMessage_result)
getMessage_result.thrift_spec = (
